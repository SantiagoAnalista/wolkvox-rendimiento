...
def test_publicar_crea_la_carpeta_del_mes_si_no_existe(tmp_path):
    ...
    excel = tmp_path / "analisis_gestion_2026-09-01_0810.xlsx"
...
def test_un_corte_nuevo_reemplaza_al_anterior_del_mismo_dia(tmp_path):
    ...
    crear(carpeta, "analisis_gestion_2026-08-18_0810.xlsx",
          "analisis_gestion_2026-08-18_1210.xlsx")
    excel = tmp_path / "analisis_gestion_2026-08-18_1610.xlsx"
...
def test_el_informe_del_dia_no_se_lleva_por_delante_el_de_la_semana(tmp_path):
    """El comodín 'analisis_gestion_2026-08*' casaría con los diarios: por eso
    la comparación es por expresión regular sobre la etiqueta completa."""
    carpeta = tmp_path / "2026" / "08. Agosto" / "Infomes de Gestion"
    crear(carpeta, "analisis_gestion_2026-S33.xlsx", "analisis_gestion_2026-08.xlsx")
    excel = tmp_path / "analisis_gestion_2026-08-18_1610.xlsx"
    excel.write_text("nuevo", encoding="utf-8")
...
def test_el_mensual_tampoco_borra_los_diarios(tmp_path):
    ...
    carpeta = tmp_path / "2026" / "08. Agosto" / "Infomes de Gestion"
    crear(carpeta, "analisis_gestion_2026-08-18_1610.xlsx")
    excel = tmp_path / "analisis_gestion_2026-08.xlsx"
...
def test_un_archivo_abierto_en_excel_no_tumba_la_publicacion(tmp_path, monkeypatch):
    ...
    def unlink_falla(self, *a, **kw):
        if self.name == "analisis_gestion_2026-08-18_0810.xlsx":
    ...
    assert (carpeta / "analisis_gestion_2026-08-18_0810.xlsx").exists()
