...
|---|---|---|
| `mes` | `gestion_wolkvox_2026-07.xlsx` | 5 días trabajados |
| `semana` | `gestion_wolkvox_2026-S31.xlsx` | 2 días |
| `dia` | `gestion_wolkvox_2026-08-12.xlsx` | 1 día |
...
Genera **un Excel por mes** (`gestion_wolkvox_2026-07.xlsx`, `…-08.xlsx`) con
...
etiqueta completa, porque el comodín `gestion_wolkvox_2026-08*` casaría
